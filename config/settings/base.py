...
MIDDLEWARE = [
    ...
    'apps.core.admin_middleware.AdminAccessMiddleware',  # Bloquear Django Admin a no-superadmins
]
...
EMAIL_TIMEOUT = config('EMAIL_TIMEOUT', default=10, cast=int)  # Timeout en segundos para evitar bloqueos
